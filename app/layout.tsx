...
const VARIANT_SCRIPT = `(function(){try{var p=new URLSearchParams(location.search);var d=document.documentElement;var m={nav:['underline','pill','slide'],accordion:['crisp','soft'],entrance:['stagger','fade','none'],heroweight:['600','500','300'],darktheme:['cool','warm']};var s={};try{s=JSON.parse(localStorage.getItem('site-variants'))||{};}catch(e){}for(var k in m){var v=p.get(k);if(!(v&&m[k].indexOf(v)>=0)){v=s[k];}if(v&&m[k].indexOf(v)>=0){d.setAttribute('data-'+k,v);}}}catch(e){}})();`;

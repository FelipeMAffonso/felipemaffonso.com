...
/* ============================================================
   Publications — content carried over VERBATIM from research.njk.
   Citations (with bold author), abstracts, DOIs, links, covers,
   button labels/descriptions are unchanged. The panel that renders
   this is a LOCKED design; this file is only the data.
   ============================================================ */

export type LinkKind = "journal" | "download" | "osf" | "github" | "arxiv" | "psyarxiv" | "ssrn";
...
export const journals: Pub[] = [
  ...
  },
  {
    ...
    citation: (
      <>
        <strong>Affonso, Felipe M.</strong> (forthcoming), &quot;Brief Commentary: A Framework for Detecting AI Agents in Online Research,&quot; <em>Journal of Consumer Research</em>.
      </>
    ),
    links: [
  ...
  },
  {
    ...
    citation: (
      <>
        <strong>Affonso, Felipe M.</strong> (2025), &quot;Consumer Responses to Infectious Disease Cues: An Integrative Framework and Research Agenda,&quot; <em>European Journal of Marketing</em>, 59 (4), 973–98.
      </>
    ),
    links: [
      { kind: "journal", href: "https://doi.org/10.1108/EJM-01-2024-0070", label: "Journal website", desc: "Full text" },
      { kind: "ssrn", href: "https://papers.ssrn.com/abstract=6609998", label: "SSRN", desc: "Preprint with PDF download" },
      { kind: "download", href: "/files/papers/disease-cues.md", label: "Machine-readable", desc: "Markdown (.md)", download: true },
    ],
    cover: { src: "/images/covers/disease-cues.jpg", alt: "European Journal of Marketing", w: 520, h: 717 },
    abstract: (
      <>
        <strong>Purpose:</strong> This paper aims to develop an integrative framework explaining how infectious disease cues influence consumer behavior by connecting evolutionary psychology and behavioral immune system literature with consumer research; <strong>Design/methodology/approach:</strong> The paper synthesizes pathogen-avoidance psychology and consumer behavior research to identify three psychological changes (affect, cognition, motivation) influencing consumer responses, developing theoretical propositions across five domains while identifying boundary conditions; <strong>Findings:</strong> Disease cues trigger changes in affect (disgust, anxiety), cognition (narrowed attention) and motivation (self-protection). These influence consumer responses across self-regulation, social behavior/identity, information processing, evaluation and prosocial/sustainable behaviors. The framework identifies boundary conditions moderating these effects; <strong>Research limitations/implications:</strong> The framework advances understanding of disease threats&apos; influence on consumer behavior and suggests future research directions, including contextual effects and individual differences; <strong>Practical implications:</strong> The framework helps marketers predict consumer responses to disease cues, offering insights for marketing strategies during health crises and normal times; <strong>Originality/value:</strong> To the best of the author&apos;s knowledge, this paper provides the first comprehensive framework explaining disease cues&apos; systematic influence on consumer behavior through psychological changes, extending behavioral immune system theory into consumer domains.
      </>
    ),
  },
  {
    id: "marketing-by-design",
    citation: (
      <>
        <strong>Affonso, Felipe M.</strong> and Chris Janiszewski (2023), &quot;Marketing by Design: The Influence of Perceptual Structure on Brand Performance,&quot; <em>Journal of Marketing</em>, 87 (5), 736–54.
      </>
    ),
    links: [
      { kind: "journal", href: "https://doi.org/10.1177/00222429221142281", label: "Journal website", desc: "Full text" },
      { kind: "ssrn", href: "https://papers.ssrn.com/abstract=6609978", label: "SSRN", desc: "Preprint with PDF download" },
      { kind: "download", href: "/files/papers/marketing-by-design.md", label: "Machine-readable", desc: "Markdown (.md)", download: true },
      { kind: "osf", href: "https://osf.io/f95e4/", label: "Data and code (OSF)", desc: "osf.io/f95e4" },
    ],
    cover: { src: "/images/covers/marketing-by-design.png", alt: "Journal of Marketing", w: 281, h: 360 },
    abstract: (
      <>
        <strong>Abstract:</strong> Visual marketing communications consist of two components: (1) semantic content (e.g., headings, images, copy) that communicates a brand&apos;s positioning, benefits, and personality and (2) visual design (e.g., font selection, image size, the organization of the content) that encourages inferences about brand claims. The authors investigate how visual design can be used to encourage inferences that support brand claims and improve brand performance. They find that brands with a utilitarian positioning perform better when the visual design of their marketing communications encourages structured perceptions, whereas brands with a hedonic positioning perform better when the visual design of their marketing communications encourages unstructured perceptions. In both cases, (un)structured perceptions encourage inferences that reinforce brand claims and, consequently, improve brand performance. This research offers actionable insights into how marketing communication specialists can coordinate logo design, product design, package design, visual merchandising, and retail environments to reinforce brand claims.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    citation: (
      <>
        Hernandez, Jose Mauro da Costa, Scott Wright, and <strong>Felipe M. Affonso</strong> (2019), &quot;The Importance of Advertising Skepticism for Brand Extension Appeals,&quot; <em>Psychology &amp; Marketing</em>, 36 (7), 687–99.
      </>
    ),
    links: [
      { kind: "journal", href: "https://doi.org/10.1002/mar.21205", label: "Journal website", desc: "Full text" },
      { kind: "ssrn", href: "https://papers.ssrn.com/abstract=6609798", label: "SSRN", desc: "Preprint with PDF download" },
      { kind: "download", href: "/files/papers/ad-skepticism.md", label: "Machine-readable", desc: "Markdown (.md)", download: true },
    ],
    cover: { src: "/images/covers/ad-skepticism.jpg", alt: "Psychology & Marketing", w: 761, h: 1000 },
    abstract: (
      <>
        <strong>Abstract:</strong> According to existing research, ad persuasiveness decreases as advertising skepticism (i.e., the tendency to disbelieve advertising claims) increases. What remains unclear, however, is whether or not this effect extends to brand extension appeals. We suggest that the effect may vary according to brand extension similarity. Three studies test this assertion while providing process evidence and boundary conditions for the proposed effect. According to the findings, consumers automatically transfer associations from parent brands to highly similar extensions or automatically block these associations in the case of highly dissimilar extensions—reducing the impact of advertising skepticism on ad persuasiveness. At moderate levels, however, extension similarity is less predictive of the transfer process, increasing the negative effect of advertising skepticism on persuasion. Consistent with this account, the results identify brand transfer (i.e., the ability of the parent brand to make the extension) as the underlying mechanism explaining the advertising skepticism effect for moderately similar brand extension appeals. Furthermore, the results show how marketers can reduce these effects, and increase extension success, by emphasizing extension attributes that are shared with the parent brand. Collectively, these results provide a unique theoretical view, improving our understanding of advertising skepticism and the drivers of brand extension success.
      </>
    ),
  },
];

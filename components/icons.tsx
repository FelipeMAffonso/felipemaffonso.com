/* ============================================================
   Icons — carried over VERBATIM from the current site markup.
   Brand marks (OSF flower, GitHub, SSRN/arXiv/PsyArXiv logos) are
   locked and never swapped. Stroked utility glyphs use the shared
   .pub-link-icon (stroke) styling; brand vectors add --fill.
   ============================================================ */

// --- publication action-button glyphs ---

export function JournalIcon() {
  // external-link (Journal website / DOI)
  return (
    <svg className="pub-link-icon" viewBox="0 0 24 24" aria-hidden="true">
...
export function DownloadIcon() {
  // download arrow (Machine-readable .md / PDF)
  return (
    <svg className="pub-link-icon" viewBox="0 0 24 24" aria-hidden="true">
...
export function OsfIcon() {
  // OSF flower — brand mark (fill), locked
  return (
    <svg className="pub-link-icon pub-link-icon-fill" viewBox="0 0 24 24" aria-hidden="true">
...
export function GitHubGlyph() {
  // GitHub mark — brand (fill), used for interactive explorers / repos
  return (
    <svg className="pub-link-icon pub-link-icon-fill" viewBox="0 0 24 24" aria-hidden="true">
...
// Brand logo images (full colour — never tinted)
export function ArxivIcon() {
  // eslint-disable-next-line @next/next/no-img-element
  return <img className="pub-link-icon" src="/images/arxiv-icon.png" alt="arXiv" width={16} height={16} style={{ width: 16, height: 16 }} />;
}
export function PsyArxivIcon() {
  // eslint-disable-next-line @next/next/no-img-element
  return <img className="pub-link-icon" src="/images/psyarxiv-icon.png" alt="PsyArXiv" width={16} height={16} style={{ width: 16, height: 16 }} />;
}
export function SsrnIcon() {
  // eslint-disable-next-line @next/next/no-img-element
  return <img className="pub-link-icon" src="/images/ssrn-icon.ico" alt="SSRN" width={16} height={16} style={{ width: 16, height: 16 }} />;
}

// --- contact / social icons (verbatim) ---

export function ScholarIcon() {
  return (
    <svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M5.242 13.769L0 9.5 12 0l12 9.5-5.242 4.269C17.548 11.249 14.978 9.5 12 9.5c-2.977 0-5.548 1.748-6.758 4.269zM12 10a7 7 0 1 0 0 14 7 7 0 0 0 0-14zm0 3c2.21 0 4 1.79 4 4s-1.79 4-4 4-4-1.79-4-4 1.79-4 4-4z" />
    </svg>
  );
}
...
export function ExpertsIcon() {
  return (
    <svg className="social-icon" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 2L2 7v2h20V7L12 2zm0 2.18L18.18 7H5.82L12 4.18zM4 10v8h2v-8H4zm5 0v8h2v-8H9zm5 0v8h2v-8h-2zm5 0v8h2v-8h-2zM2 19v3h20v-3H2z" />
    </svg>
  );
}

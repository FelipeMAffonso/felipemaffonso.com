...
*The framework proceeds through four steps arranged in a cycle. Step 1 (Identify Architectural Constraints): systematic review of computer science benchmarks and vision-language model evaluations for documented limitations showing large human-model performance gaps. Five constraints were identified: training data overfitting, spatiotemporal reasoning, spatial reasoning with mental simulation, cross-modal binding, and compositional counting. Step 2 (Design Survey-Compatible Implementations): each constraint is transformed into a visual survey question ("cognitive trap") that forces processing through the constrained pathway, producing diagnostic failure patterns. Seven stimuli were designed. Step 3 (Validate Against Models and Humans): human performance must exceed 75% accuracy and the human-model gap must exceed 30 percentage points. Six of seven traps were retained (86.8% average human accuracy vs. 22.5% pooled model accuracy). Step 4 (Deploy in Research Context): embed traps in surveys, establish classification thresholds, and apply classification rules. Result: 97.1% agent detection with 4.1% false positive rate. The cycle is ongoing: new AI evaluation research documents new constraints, generating new traps.*
...
*Scatter plot showing average cognitive trap pass rate (%) for 34 vision-language models on the y-axis plotted against model release date (March 2024 through February 2026) on the x-axis. Each dot represents one model, colored by provider: Anthropic (blue), OpenAI (green), and Google (red). Frontier models are labeled. A dashed horizontal line marks the 86.8% average human baseline. The OLS trend line is essentially flat (+0.51 pp/month, p = .282), showing no significant improvement over nearly two years. Performance is non-monotonic within product lines: GPT-4o-mini (July 2024, 36.7%) outperforms GPT-4.1 (April 2025, 5.0%); Gemini 2.0 Flash (31.7%) outperforms Gemini 2.5 Flash (1.7%). The best-performing model (Gemini 3 Flash with extended thinking, 65.0%) remains 21.8 percentage points below human performance. No model passes all six traps.*
...
*Bar chart comparing detection rates of different methods against 526 deployed AI agents. Cognitive traps (green bar) detect 97.1% (511/526) of agents. CAPTCHA at the optimal 0.90 threshold detects 93.9%. All other methods detect fewer than 5%: CAPTCHA at the standard 0.5 threshold detects 4.6% (24/526); traditional attention checks combined detect only 2.3% (12/526), broken down as IMC 0.2%, obvious answer 0.2%, memory check 0.8%, and straight-lining 1.3%. Fast completion timing detects 0.2% (1/526). The 42-fold performance gap between cognitive traps and traditional methods (97.1% vs. 2.3%) is visually striking.*
...
*Paired bar chart or dot plot showing human pass rates (high) versus agent pass rates (low) for each of the six cognitive traps, ordered by discrimination (human-agent gap). Muller-Lyer: 92.8% human pass vs. 5.9% agent pass (86.9 pp discrimination). Cafe Wall: 88.4% human vs. 5.1% agent (83.2 pp). Moving Robot: 77.9% human vs. 0.4% agent (77.5 pp). Ebbinghaus: 95.6% human vs. 22.4% agent (73.2 pp). Surrounded Planets: 96.5% human vs. 44.5% agent (52.0 pp). Colliding Oranges: 88.7% human vs. 49.4% agent (39.2 pp). All differences significant at p < .001.*
...
*Four-panel histogram showing the distribution of cognitive trap scores (0-6 correct) for each agent platform. A dashed vertical line marks the 3-failure detection threshold (score of 3 or higher passes). Google Project Mariner (n=134): agents cluster at scores of 0-1, with 100% detection rate. Claude Sonnet 4.5 via Cursor (n=132): agents cluster at scores of 0-1, with 100% detection rate. Perplexity Comet (n=131): agents show slightly higher scores but remain predominantly sub-threshold, with 94.7% detection. ChatGPT Agent (n=129): agents show the highest scores among platforms but still mostly below threshold, with 93.8% detection. No agent from any platform scored 6/6.*
...
*Dumbbell plot where each row represents one of 12 base models with paired standard (circle) and extended-thinking (diamond) variants connected by horizontal lines. Green lines indicate improvement, red lines indicate decline. Models are sorted by magnitude of thinking effect. The largest gains: Claude Sonnet 4.5 (+30.0 pp, from 26.7% to 56.7%), Gemini 2.5 Flash-Lite (+28.4 pp, from 3.3% to 31.7%). The largest declines: GPT-5.1 (-20.0 pp, from 20.0% to 0.0%). Eight of 12 pairs show improvement (mean +8.8 pp), four show declines. A dashed vertical line marks the 86.8% human baseline, which no thinking model reaches. The best thinking model (Gemini 3 Flash at 65.0%) remains 21.8 pp below human performance.*
...
*Grouped bar chart or dual-axis plot comparing four detection methods on sensitivity (agent detection rate) and false positive rate (humans incorrectly flagged). Cognitive Traps (3+ failures): 97.1% sensitivity (511/526 agents detected), 4.1% FPR, 95.9% specificity. CAPTCHA at optimal 0.90 threshold: 93.9% sensitivity (494/526), 12.4% FPR, 87.6% specificity. CAPTCHA at standard 0.5 threshold: 4.6% sensitivity (24/526), 1.0% FPR, 99.0% specificity. Traditional methods (any): 2.3% sensitivity (12/526). Cognitive traps achieve the best combination of high sensitivity with low false positives. CAPTCHA at 0.90 approaches cognitive trap sensitivity but at three times the false positive rate.*

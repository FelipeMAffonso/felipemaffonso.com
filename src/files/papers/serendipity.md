...
::::::: masthead-info
::: {.citation .long}
[[Journal of Marketing]{property="name"}]{property="isPartOf" typeof="Periodical"}[, ]{.delimiter}[Volume [85]{property="volumeNumber"}]{property="isPartOf" typeof="PublicationVolume"}[, ]{.delimiter}[Issue [4]{property="issueNumber"}]{property="isPartOf" typeof="PublicationIssue"}[, ]{.delimiter}[July 2021]{property="datePublished"}[, ]{.delimiter}[Pages [141]{property="pageStart"}-[157]{property="pageEnd"}]{property="pagination"}
:::
...
, [Article Reuse Guidelines](https://sagepub.com/journals-permissions)
::::

::: doi
[https://doi.org/10.1177/00222429211000344](https://doi.org/10.1177/00222429211000344){property="sameAs"}
:::
:::::::
...
# Serendipity: Chance Encounters in the Marketplace Enhance Consumer Satisfaction {property="name"}
::::
::::::::::::

::: authors
[[Aekyoung]{property="givenName"} [Kim]{property="familyName"}[https://orcid.org/0000-0003-2995-7482](https://orcid.org/0000-0003-2995-7482){.orcid-id property="identifier" aria-label="ORCID identifier"}]{property="author" typeof="Person"}, [[Felipe M.]{property="givenName"} [Affonso]{property="familyName"}]{property="author" typeof="Person"}, [[Juliano]{property="givenName"} [Laran]{property="familyName"}]{property="author" typeof="Person"}, and [[Kristina M.]{property="givenName"} [Durante]{property="familyName"}[https://orcid.org/0000-0002-2657-7700](https://orcid.org/0000-0002-2657-7700){.orcid-id property="identifier" aria-label="ORCID identifier"}]{property="author" typeof="Person"}
:::
...
::::: {#index.xhtml_keywords .keywords property="keywords"}
::: heading
Keywords
:::

::: {}
[choice]{.keyword}, [enjoyment]{.keyword}, [product recommendations]{.keyword}, [satisfaction]{.keyword}, [serendipity]{.keyword}, [subscription services]{.keyword}
:::
:::::
...
::: {#index.xhtml_corresp1-00222429211000344 .corresp}
Aekyoung Kim is Lecturer of Marketing, University of Sydney Business School, University of Sydney, Australia (email: <aekyoung.kim@sydney.edu.au>). Felipe M. Affonso is doctoral student in Marketing, University of Florida, USA (email: <felipe.affonso@warrington.ufl.edu>). Juliano Laran is Research Fellow, Faculty of Business and Economics, University of Basel, Switzerland (email: <juliano.laran@unibas.ch>). Kristina M. Durante is Professor of Marketing, Rutgers Business School, Rutgers University (email: <kdurante@business.rutgers.edu>).
:::
:::::
::::::
:::::::::::::::::::::::
...
::: {role="paragraph"}
The eighteenth-century writer Horace Walpole originally coined the term "serendipity" to describe, in a Persian fairy tale, the idea of people "always making discoveries, by accidents and sagacity, of things they were not in quest of" ([Walpole 1754](#index.xhtml_bibr47-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr47-00222429211000344"}, p. 407). Today, serendipity is defined as "finding valuable or agreeable things not sought for" (<https://www.merriam-webster.com/dictionary/serendipity>), looking for something and finding something else that is actually more suitable to one's needs ([Parker 2008](#index.xhtml_bibr39-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr39-00222429211000344"}), and a positive and unexpected discovery ([Herlocker et al. 2004](#index.xhtml_bibr19-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr19-00222429211000344"}). Despite these definitions, we lack an understanding of serendipity that applies more directly to marketing-relevant phenomena.
:::

::: {role="paragraph"}
Serendipity in the marketplace refers to the set of feelings resulting from an encounter involving a chance finding of a product, service, or experience not directly chosen by the consumer. It happens when a consumer is not looking for anything specific or looking for something and discovers something else ([Cunha 2005](#index.xhtml_bibr8-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr8-00222429211000344"}; [McCay-Peet and Toms 2010](#index.xhtml_bibr34-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr34-00222429211000344"}). Thus, serendipity is an unexpected event that occurs when the consumer is in either a passive state, not trying to discover anything, or an active state, trying to find something of value. As such, we propose that feelings of serendipity in the consumer domain result from an encounter that is (1) positive, (2) unexpected, and (3) involving some degree of chance ([Makri and Blandford 2012](#index.xhtml_bibr32-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr32-00222429211000344"}; [Matt et al. 2014](#index.xhtml_bibr33-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr33-00222429211000344"}; [McCay-Peet and Toms 2010](#index.xhtml_bibr34-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr34-00222429211000344"}).
:::

:::::: {#index.xhtml_sec-1-1 .section}
### The Properties of Serendipity

::: {role="paragraph"}
Unexpectedness is the cognitive process responsible for the feeling of surprise ([Reisenzein, Horstmann, Schützwohl 2019](#index.xhtml_bibr41-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr41-00222429211000344"}), which can be a positive or negative emotional reaction ([Faraji-Rad and Pham 2017](#index.xhtml_bibr11-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr11-00222429211000344"}; [Mellers et al. 1997](#index.xhtml_bibr36-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr36-00222429211000344"}). An unexpected surprise that is negative can enhance negative reactions, but when a surprise is positive (i.e., brings value to the consumer and generates positive emotions), it enhances satisfaction ([Lindgreen and Vanhamme 2003](#index.xhtml_bibr30-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr30-00222429211000344"}; [Westbrook and Oliver 1991](#index.xhtml_bibr48-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr48-00222429211000344"}). For example, consumers experienced greater enjoyment from winning a smaller, unexpected amount of money compared with a larger, but expected, amount of money ([Mellers et al. 1997](#index.xhtml_bibr36-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr36-00222429211000344"}). In addition, surprise incentives (e.g., coupons) are viewed positively and lead to increased spending on unplanned purchases ([Heilman, Nakamoto, and Rao 2002](#index.xhtml_bibr17-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr17-00222429211000344"}; [Valenzuela, Strebel, and Mellers 2010](#index.xhtml_bibr45-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr45-00222429211000344"}).
:::

::: {role="paragraph"}
Although serendipitous events are unexpected, surprise is not the only component of serendipity. For an event to generate feelings of serendipity, it must be attributed to some chance or, in the case of chance that leads to positive experiences, luck. This occurs because one consequence of feeling surprised is the search for attribution ([Reisenzein, Horstmann, Schützwohl 2019](#index.xhtml_bibr41-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr41-00222429211000344"}; [Stiensmeir-Pelster, Martini, and Reisenzein 1995](#index.xhtml_bibr44-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr44-00222429211000344"}). For example, you may be surprised to receive a free cup of coffee when entering your favorite coffee shop but then see a sign saying that they are giving away coffee to their loyalty club patrons. However, if there is no sign, you may attempt to infer what happened by making an attribution to chance ("They are randomly selecting people to receive a free coffee"), and the search for attribution ends ([Feather and Simon 1971](#index.xhtml_bibr12-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr12-00222429211000344"}; [Reisenzein, Horstmann, and Schützwohl 2019](#index.xhtml_bibr41-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr41-00222429211000344"}). In this view, while receiving a cup of coffee with a clear attribution (you are a loyalty club member) is nice, perceiving that you were lucky to be selected may be more satisfying.
:::

::: {role="paragraph"}
Thus, when marketers deliver a product, service, or experience in a way that is positive, unexpected, and involving chance, this will generate congruent feelings. Consumers will feel that the encounter was a good surprise, make attributions to chance, and feel lucky that it happened. We collectively call these "feelings of serendipity." These feelings, in turn, can influence an array of consumer-relevant outcomes, such as satisfaction with the entire experience with a company. In addition, feelings of serendipity could make such experiences feel more meaningful, as people attach more meaning to events that they perceive to occur by chance or luck. In fact, ascribing meaning to chance events is most prevalent for positive experiences ([King et al. 2006](#index.xhtml_bibr22-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr22-00222429211000344"}; [Krantz 1998](#index.xhtml_bibr24-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr24-00222429211000344"}; [Shanahan and Porfeli 2006](#index.xhtml_bibr42-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr42-00222429211000344"}). For example, a positive event attributed to chance may lead people to think about ways in which things could have happened less positively ([Kray et al. 2010](#index.xhtml_bibr25-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr25-00222429211000344"}), making them think the event was "meant to be," and that "there is a reason why it occurred." If feelings of serendipity enhance satisfaction and meaning, serendipity should influence other outcomes, such as likelihood of recommending a product or service, willingness to pay, and willingness to buy additional products or services from a company.
:::
::::::

:::::::::::::: {#index.xhtml_sec-1-2 .section}
### Serendipity in the Marketplace

::: {role="paragraph"}
[Figure 1](fig1-00222429211000344.xhtml) presents a summary of the influence of serendipity on consumer-relevant outcomes. Serendipitous events happen without people choosing them or knowledge that they are going to happen. In our previous example, the person chose to go to the coffee shop that day but did not choose to get a free cup of coffee. A consumer chooses to listen to a music streaming service but does not choose the song that plays once they start listening. These examples raise the question of when serendipity occurs and when marketers can take advantage of it.
:::

::: {role="paragraph"}
Serendipity occurs when, at the time of purchase or consumption, an encounter results in the feelings mentioned previously (i.e., a good surprise, luck, attributions to chance). In such contexts, the product, service, or experience may be judged as quite positive ([Matt et al. 2014](#index.xhtml_bibr33-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr33-00222429211000344"}). Consider, for example, subscription services (e.g., Stitch Fix). The consumer chooses the company and whether they want to receive a box with clothes (or other products) chosen by the company on the basis of a profile they fill out. While the company has information about the consumer's preferences, it is never perfect information, and the consumer is not choosing which products to receive. We propose that a large part of the appeal of such subscription services is that there is an element of surprise and chance (i.e., there is randomness in the process). When the products received are good ("positive"), this generates feelings of serendipity, increasing satisfaction compared with when consumers choose their products.
:::

::: {role="paragraph"}
A similar example is streaming and other recommendation systems, which are the focus of much of the literature on serendipity ([Kotkov, Wang, and Veijalainen 2016](#index.xhtml_bibr23-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr23-00222429211000344"}). These recommendations are based on consumers' preferences, but the recommendations are unexpected and there is a chance component to them. Thus, when the recommendation is good, the entire experience is more enjoyable because the context generates feelings of serendipity ([Leong, Vetere, and Howard 2008](#index.xhtml_bibr29-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr29-00222429211000344"}; [Melo and Carvalhais 2013](#index.xhtml_bibr37-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr37-00222429211000344"}; [Zhang et al. 2012](#index.xhtml_bibr49-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr49-00222429211000344"}). If a consumer places their favorite songs on a playlist and chooses to play one of them, the listening experience will not generate feelings of serendipity, and enjoyment may not be as high. In support of these predictions, qualitative research on how consumers listen to music suggests that when consumers perceive that they encountered songs and information unexpectedly and by chance, they indicate that their listening experience was better ([Celma 2010](#index.xhtml_bibr6-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr6-00222429211000344"}; [Leong, Vetere, and Howard 2008](#index.xhtml_bibr29-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr29-00222429211000344"}). The implication is that consumers appreciate choosing ([Brehm 1972](#index.xhtml_bibr3-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr3-00222429211000344"}; [Sharot, De Martino, and Dolan 2009](#index.xhtml_bibr43-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr43-00222429211000344"}), but serendipitously encountering a product can be more enjoyable as long as the product brings value to the consumer.
:::

:::::::::: {role="paragraph"}
As an additional example, consider experiences such as going to a museum. If a consumer knows beforehand which work of art (e.g., a painting) they plan to see, this may be enjoyable but not serendipitous. Alternatively, if the museum places beautiful paintings in locations where consumers may find them by surprise (e.g., immediately upon turning a corner), the experience may become serendipitous and even more enjoyable. Finally, consider sampling at a supermarket. While the consumer has chosen to go grocery shopping, and may even expect that there will be some sampling opportunities, coming across a sampling of a favorite varietal of wine can generate feelings of serendipity, which may lead to heightened enjoyment of the wine and a decision to buy it. The relationship illustrated in these examples, depicted with solid lines in [Figure 1](fig1-00222429211000344.xhtml), leads to our focal hypotheses:

::::::::: {role="list"}
::::: {role="listitem"}
:::: content
::: {role="paragraph"}
**H~1a~:** A marketplace encounter that is positive, is unexpected, and involves some degree of chance improves consumer outcomes compared with an encounter that the consumer directly chooses.
:::
::::
:::::
...
:::: content
::: {role="paragraph"}
**H~1b~:** The effect of a marketplace encounter that is positive, is unexpected, and involves some degree of chance on consumer outcomes is mediated by feelings of serendipity.
:::
::::
:::::
:::::::::
...
:::: content
::: {role="paragraph"}
**H~3~:** An increase in the perceived amount of randomness involved in an encounter increases feelings of serendipity and improves consumer outcomes, whereas the perception that an encounter was selected deterministically diminishes feelings of serendipity and consumer outcomes.
:::
::::
:::::
::::::
...
:::::::::::::::: {#index.xhtml_sec-2-2 .section data-type="results"}
### Results

:::: {#index.xhtml_sec-2-2-1 .section}
#### Satisfaction
...
:::: {#index.xhtml_sec-2-2-3 .section}
#### Willingness to extend the subscription
...
:::: {#index.xhtml_sec-2-2-4 .section}
#### Meaningfulness

::: {role="paragraph"}
A 2 (condition) × 4 (company) ANOVA revealed a main effect of condition, such that participants reported higher meaningfulness in the serendipity condition (M = 5.12, SD = 1.34) than in the personal choice condition (M = 4.72, SD = 1.48; F(1, 803) = 16.48, *p* \< .001).^[^1]^
:::
::::

::::: {#index.xhtml_sec-2-2-5 .section}
#### Mediation by feelings of serendipity

::: {role="paragraph"}
A 2 (condition) × 4 (company) ANOVA revealed a main effect of condition, such that participants reported greater feelings of serendipity in the serendipity condition (M = 5.50, SD = 1.02) than in the personal choice condition (M = 5.07, SD = 1.36; F(1, 803) = 25.89, *p* \< .001). We conducted bootstrapping mediation analyses (PROCESS Model 4; [Hayes 2018](#index.xhtml_bibr16-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr16-00222429211000344"}) using condition (serendipity vs. personal choice) as the independent variable and serendipity as the mediator for each of the outcomes.
:::
...
:::: {#index.xhtml_sec-2-2-6 .section}
#### Expectations

::: {role="paragraph"}
A 2 (condition) × 4 (company replicate) ANOVA did not reveal main effects of condition (M~serendipity~ = 5.34, SD = 1.10; M~personalchoice~ = 5.27, SD = 1.05; F(1, 803) = .91, *p* = .340), showing that the findings cannot be explained by consumers creating higher expectations when they choose the products they will receive.
:::
::::
::::::::::::::::

:::: {#index.xhtml_sec-2-3 .section data-type="discussion"}
### Discussion

::: {role="paragraph"}
Using retrospective reports from real purchase experiences, Study 1 found that having products sent by a subscription service without knowing what the specific products are leads to more positive consumer responses than personally choosing products. This effect, which supports H~1a~ and H~1b~, was due to feelings of serendipity, and not to an increase in expectations about the products. Further, the effect held while controlling for an array of factors that may influence consumer responses (i.e., product cost, product type, perceived quality, number of products, shipping period, time from the purchase, general attitudes toward the company, and satisfaction with the purchase process), meaning that the effect of serendipity is robust and goes beyond any possible effect of such factors.
:::
::::
:::::::::::::::::::::::::::
...
::: {role="paragraph"}
We have theorized that the experience needs to be positive for serendipity to occur. In Study 2, we examine the role of valence in the context of seeing a painting in a museum. Participants either chose which painting they wanted to see or had a painting randomly chosen for them. We also had a baseline condition in which participants simply saw a painting. The baseline condition allowed us to determine whether the focal effect occurs because of a positive effect in the serendipity condition or a negative effect in the choice condition. Consistent with H~2~, we predicted that having a painting randomly chosen would increase enjoyment relative to a baseline and a personal choice condition when the painting was attractive (i.e., positive valence), but not when it was unattractive (i.e., negative valence). This context is relevant to practice, as serendipity can also occur when consumers have unstructured experiences such as those that occur in a museum or an amusement park. Thus, findings in this context may help managers configure these experiences in a way that generates feelings of serendipity.
:::

::::::::: {#index.xhtml_sec-3-1 .section data-type="methods"}
### Method

:::: {#index.xhtml_sec-3-1-1 .section}
#### Participants and design
...
:::::: {#index.xhtml_sec-3-1-2 .section data-type="methods"}
#### Procedure
...
:::::::::: {#index.xhtml_sec-4-1 .section data-type="methods"}
### Method

:::: {#index.xhtml_sec-4-1-1 .section}
#### Participants and design
...
::::::: {#index.xhtml_sec-4-1-2 .section data-type="methods"}
#### Procedure
...
:::::::::::::: {#index.xhtml_sec-4-2 .section data-type="results"}
### Results

:::: {#index.xhtml_sec-4-2-1 .section}
#### Manipulation check
...
:::: {#index.xhtml_sec-4-2-2 .section}
#### Enjoyment

::: {role="paragraph"}
A 2 (initial selection randomness) × 2 (final selection randomness) ANOVA on enjoyment revealed a main effect of randomness in the final selection (F(1, 385) = 40.08, *p* \< .001), such that enjoyment was higher when the movie was randomly (M = 73.45, SD = 22.10) rather than deterministically (M = 56.63, SD = 30.76) selected. There was no main effect of randomness in the initial selection (F(1, 385) = 2.50, *p* = .114). The interaction was significant (F(1, 385) = 4.05, *p* = .045; see [Figure 3](fig3-00222429211000344.xhtml)). When there was a high degree of randomness in the final selection, enjoyment was greater in the high- (M = 78.41, SD = 19.28) than in the low- (M = 68.77, SD = 23.61; F(1, 385) = 6.80, *p* = .009) randomness-in-the-initial-selection condition. When there was a low degree of randomness in the final selection, there was no difference between the high- (M = 56.03, SD = 31.61) and low- (M = 57.19, SD = 30.11) randomness-in-the-initial-selection conditions (F \< 1). None of the results for the measured alternative explanations could explain the pattern of results on enjoyment and the following dependent variables (for detailed analyses, see Web Appendix C).
:::

<figure id="fig3-00222429211000344" class="graphic figure" epub:type="figure">
<a href="fig3-00222429211000344.xhtml"><img src="images/large/10.1177_00222429211000344-fig3.jpg" style="width: min(100%,500px);" data-height="1829" data-width="1911" aria-labelledby="fig3-00222429211000344" /></a>
<figcaption><div class="caption">
<span class="heading">Figure 3</span>. Study 3 results.
</div>
<div class="notes">
...
:::: {#index.xhtml_sec-4-2-3 .section}
#### Interest in the platform (yes vs. no)
...
:::: {#index.xhtml_sec-4-2-4 .section}
#### Interest in the platform (presence of valid email)
...
::::::::: {#index.xhtml_sec-5-1-2 .section data-type="methods"}
#### Procedure
...
:::::::::::::::: {#index.xhtml_sec-5-2 .section data-type="results"}
### Results

:::: {#index.xhtml_sec-5-2-1 .section}
#### Manipulation checks
...
:::: {#index.xhtml_sec-5-2-2 .section}
#### Satisfaction

::: {role="paragraph"}
A 2 (condition) × 2 (information) ANOVA revealed a main effect of information, such that satisfaction was higher when the information was nondiagnostic (M = 5.18, SD = 1.62) rather than diagnostic (M = 4.65, SD = 1.74; F(1, 389) = 10.23, *p* = .001). There was no main effect of condition (F(1, 389) = .028, *p* = .868). The interaction was significant (F(1, 389) = 23.01, *p* \< .001; see [Figure 4](fig4-00222429211000344.xhtml)). When the information was nondiagnostic, satisfaction was greater in the serendipity (M = 5.57, SD = 1.29) than in the personal choice condition (M = 4.80, SD = 1.82; F(1, 389) = 10.64, *p* = .001). When the information was diagnostic, satisfaction was greater in the personal choice (M = 5.07, SD = 1.61) than in the serendipity condition (M = 4.25, SD = 1.77; F(1, 389) = 12.41, *p* \< .001). None of the results for the measured alternative explanations could explain the pattern of results on this and the other dependent variables (for detailed analyses, see Web Appendix D).
:::

<figure id="fig4-00222429211000344" class="graphic figure" epub:type="figure">
<a href="fig4-00222429211000344.xhtml"><img src="images/large/10.1177_00222429211000344-fig4.jpg" style="width: min(100%,500px);" data-height="1824" data-width="1912" aria-labelledby="fig4-00222429211000344" /></a>
<figcaption><div class="caption">
<span class="heading">Figure 4</span>. Study 4 results.
</div>
<div class="notes">
...
:::::::: {#index.xhtml_sec-6-1 .section}
### Theoretical Implications

::: {role="paragraph"}
This research has implications for the literature on serendipity. Some research has examined consumers' appreciation for online recommendations ([Ge et al. 2010](#index.xhtml_bibr14-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr14-00222429211000344"}) but has not provided much evidence for how well recommendations work compared with personal choices and what it is about these recommendations that consumers see positively. We show that feelings of serendipity associated with a recommendation make the consumer experience more positive compared with having a personal choice, and that these feelings can influence a large set of consumer-relevant outcomes. This implies that, instead of simply making recommendations that try to match previous behavior and stated preferences, online recommendation services should design experiences that appear to involve chance, as this will make consumers more satisfied.
:::

::: {role="paragraph"}
The role of chance uncovered in this research informs the literature on surprise in the marketplace. Surprising events can be positive or negative ([Calvo and Castillo 2001](#index.xhtml_bibr4-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr4-00222429211000344"}; [Loewenstein 1994](#index.xhtml_bibr31-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr31-00222429211000344"}), and the current research suggests that studies investigating consumer responses to unexpectedness must consider the degree of chance involved. Responses to positive surprises may not be as positive if the consumer is aware that the surprise was carefully planned by a marketer. This implies that the literature on surprise should manipulate or measure the perceived amount of chance that led to something unexpected happening, as this may provide knowledge on why surprises are sometimes so positive (attributed to chance: "this was meant to be") and sometimes not (attributed: to specific events "I know exactly how this happened").
:::

::: {role="paragraph"}
The current work also contributes to the literature on uncertainty and how it influences consumption. Uncertainty and low control are associated with stress ([Durante and Laran 2016](#index.xhtml_bibr10-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr10-00222429211000344"}) and lead consumers to engage in behaviors to regain control ([Cutright and Samper 2014](#index.xhtml_bibr9-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr9-00222429211000344"}; [VanBergen and Laran 2016](#index.xhtml_bibr46-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr46-00222429211000344"}). Research investigating how uncertainty and low control influence choice and consumption should be cautious about the role of chance. Leading consumers to believe that something happened as a result of random events could backfire if the encounter turns out to be negative. The result could lead not only to lower consumer satisfaction but also to magnified negative consequences for a consumer's well-being. If an encounter becomes negative (e.g., a movie that leads a consumer to remember traumatic life events, a product the consumer is allergic to), an attribution to chance may generate a strong emotional reaction, which would otherwise be attenuated if the experience was attributed to a specific source. This does not mean that the study of serendipity should be limited because of the possibility that consumers are averse to uncertainty and low control. Instead, serendipity needs to be further explored and be accompanied by a clear understanding of what brings positive value to the consumer.
:::

::: {role="paragraph"}
Moreover, the current work shows that serendipity occurs when the consumer does not choose a specific product or experience, which means that our findings inform work on consumer preference for choice ([Botti and Iyengar 2006](#index.xhtml_bibr100-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr100-00222429211000344"}; [Botti and McGill 2006](#index.xhtml_bibr1-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr1-00222429211000344"}; [Chernev 2003](#index.xhtml_bibr7-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr7-00222429211000344"}). Prior work has shown that people generally like choosing and having more options, and that personal control over choice can increase satisfaction. Alternatively, the current research aligns with the smaller set of evidence on how choice does not always lead to greater satisfaction. This implies that the assumption that choice is preferred over not having choice must be revised to include considerations about how much serendipity is involved when there is no choice. Consumers may prefer the ability to choose, but the absence of choice can lead to greater satisfaction when the consumption context is positive, unexpected, and involves attributions to chance.
:::

::: {role="paragraph"}
Finally, this research has implications for the literature on how the absence of deliberative choice influences well-being ([Iyengar and Lepper 1999](#index.xhtml_bibr20-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr20-00222429211000344"}; [Raghunathan and Irwin 2001](#index.xhtml_bibr40-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr40-00222429211000344"}). Relatively little marketing research has examined how conditions that lack deliberate action influence consumer outcomes. Here, the lack of deliberative choice made products and experiences seem more meaningful. This is important because part of being happy is the feeling that there is meaning in life ([Lambert et al. 2013](#index.xhtml_bibr26-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr26-00222429211000344"}). A lack of meaning is averse and leads people to immediately engage in meaning restoration ([Heine, Proulx, and Vohs 2006](#index.xhtml_bibr18-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr18-00222429211000344"}). This means that, instead of focusing on understanding how consumers actively seek meaning, researchers may help consumers by putting more emphasis on events that generate meaning without the need for consumers to actively search for it. Our findings show that marketers can structure several contexts, across industries, to imbue experiences with meaning.
:::
::::::::

::::::::::: {#index.xhtml_sec-6-2 .section}
...
::: {role="paragraph"}
Further, it is unclear if the results would hold for products associated with strong, preexisting brand preferences (e.g., colas). It is possible that the effects are specific to the experience of products or services for which preexisting preferences or brand loyalty are not strong ([Chernev 2003](#index.xhtml_bibr7-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr7-00222429211000344"}). This is a common phenomenon in consumer decision-making research, as strong previous attitudes and preferences may be immune to the effect of marketer-driven manipulations. This is not something we tested in the current investigation, but could be explored in future research.
:::

::: {role="paragraph"}
Despite these limitations, we consistently found that serendipity leads to positive outcomes. Complementing previous research on the positive power of uncontrolled events ([Kray et al. 2010](#index.xhtml_bibr25-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr25-00222429211000344"}; [Morewedge et al. 2014](#index.xhtml_bibr38-00222429211000344){.biblioref role="doc-biblioref" xml-rid="bibr38-00222429211000344"}), the effects emerged because people perceived such events to involve surprises and chance. Given that little marketing research has examined consumer outcomes when events are not deliberately orchestrated, future work is poised to build on these findings to further consider the varied effects that can emerge when the absence of choice signals the presence of serendipity.
:::
::::::
:::::::::::::::::::::::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
:::: {#index.xhtml_funding .section .core-funding}
## Funding
...
::::: {#index.xhtml_orcid .section .core-orcid}
## ORCID iDs

::: {role="paragraph"}
Aekyoung Kim [https://orcid.org/0000-0003-2995-7482](https://orcid.org/0000-0003-2995-7482){.orcid-id}
:::

::: {role="paragraph"}
Kristina M. Durante [https://orcid.org/0000-0002-2657-7700](https://orcid.org/0000-0002-2657-7700){.orcid-id}
:::
:::::

:::: {#index.xhtml_supplementary-materials .section .core-supplementary-materials}
::: {role="paragraph"}
Online supplement: <https://doi.org/10.1177/00222429211000344>
:::
::::
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {role="list"}
:::: {role="listitem"}
::: {#index.xhtml_bibr100-00222429211000344 .citations}
[Botti Simona, Iyengar Sheena S. (2006), "The Dark Side of Choice: When Choice Impairs Social Welfare," *Journal of Public Policy & Marketing*, 25 (1), 24--38. [Crossref](https://doi.org/10.1509/jppm.25.1.24). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000237894300003).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr1-00222429211000344 .citations}
[Botti Simona, McGill Ann L. (2006), "When Choosing Is Not Deciding: The Effect of Perceived Responsibility on Satisfaction," *Journal of Consumer Research*, 33 (2), 211--19. [Crossref](https://doi.org/10.1086/506302). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000240732700007).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr3-00222429211000344 .citations}
[Brehm Jack W. (1972), *Responses to Loss of Freedom: A Theory of Psychological Reactance*. Morristown, NJ: General Learning Press.]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr4-00222429211000344 .citations}
[Calvo Manuel G., Castillo M. Dolores (2001), "Selective Interpretation in Anxiety: Uncertainty for Threatening Events," *Cognition and Emotion*, 15 (3), 299--320. [Crossref](https://doi.org/10.1080/02699930126040). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000167771800003).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr5-00222429211000344 .citations}
[Carmon Ziv, Wertenbroch Klaus, Zeelenberg Marcel (2003), "Option Attachment: When Deliberating Makes Choosing Feel Like Losing," *Journal of Consumer Research*, 30 (1), 15--29. [Crossref](https://doi.org/10.1086/374701). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000183354100002).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr6-00222429211000344 .citations}
[Celma Oscar (2010), "Music Recommendation," in *Music Recommendation and Discovery: The Long Tail, Long Fail, and Long Play in the Digital Music Space*, Celma Oscar, ed. Berlin: Springer-Verlag, 43--85. [Crossref](https://doi.org/10.1007/978-3-642-13287-2_3).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr7-00222429211000344 .citations}
[Chernev Alexander (2003), "When More Is Less and Less Is More: The Role of Ideal Point Availability and Assortment in Consumer Choice," *Journal of Consumer Research*, 30 (2), 170--83. [Crossref](https://doi.org/10.1086/376808). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000185215800002).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr8-00222429211000344 .citations}
[Cunha Miguel Pina (2005), "Serendipity: Why Some Organizations Are Luckier than Others," working paper, Universidade Nova de Lisboa, FEUNL Working Paper Series. [Crossref](https://doi.org/10.2139/ssrn.882782).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr9-00222429211000344 .citations}
[Cutright Keisha M., Samper Adriana (2014), "Doing It the Hard Way: How Low Control Drives Preferences for High-Effort Products and Services," *Journal of Consumer Research*, 41 (3), 730--45. [Crossref](https://doi.org/10.1086/677314). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000341836900010).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr10-00222429211000344 .citations}
[Durante Kristina, Laran Juliano (2016), "The Effect of Stress on Consumer Saving and Spending," *Journal of Marketing Research*, 53 (5), 814--28. [Crossref](https://doi.org/10.1509/jmr.15.0319). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000386257100012).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr11-00222429211000344 .citations}
[Faraji-Rad Ali, Pham Michel Tuan (2017), "Uncertainty Increases the Reliance on Affect in Decisions," *Journal of Consumer Research*, 44 (1), 1--21. [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000404534800001).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr12-00222429211000344 .citations}
[Feather Norman T., Simon Jerrold G. (1971), "Attribution of Responsibility and Valence of Outcome in Relation to Initial Confidence and Success and Failure of Self and Other," *Journal of Personality and Social Psychology*, 18 (2), 173--88. [Crossref](https://doi.org/10.1037/h0030845). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3AA1971J400800006).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr13-00222429211000344 .citations}
[Feldman Jack M., Lynch John G. (1988), "Self-Generated Validity and Other Effects of Measurement on Belief, Attitude, Intention, and Behavior," *Journal of Applied Psychology*, 73 (3), 421--35. [Crossref](https://doi.org/10.1037/0021-9010.73.3.421). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3AA1988P707800008).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr14-00222429211000344 .citations}
[Ge Yong, Xiong Hui, Tuzhilin Alexander, Xiao Keli, Gruteser Marco, Pazzani Michael (2010), "An Energy-Efficient Mobile Recommender System," in Proceedings of the 16th ACM SIGKDD International Conference on Knowledge Discovery and Data Mining, Rao Bharat, Krishnapuram Balaji, eds. New York: Association for Computing Machinery, 899--908. [Crossref](https://doi.org/10.1145/1835804.1835918).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr15-00222429211000344 .citations}
[Goldsmith Kelly, Amir On (2010), "Can Uncertainty Improve Promotions?" *Journal of Marketing Research*, 47 (6), 1070--77. [Crossref](https://doi.org/10.1509/jmkr.47.6.1070). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=000284813400007).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr16-00222429211000344 .citations}
[Hayes Andrew F. (2018), *An Introduction to Mediation, Moderation, and Conditional Process Analysis: A Regression-Based Approach*, 2nd ed. New York: Guilford.]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr17-00222429211000344 .citations}
[Heilman Carrie M., Nakamoto Kent, Rao Ambar G. (2002), "Pleasant Surprises: Consumer Response to Unexpected In-Store Coupons," *Journal of Marketing Research*, 39 (2), 242--52. [Crossref](https://doi.org/10.1509/jmkr.39.2.242.19081). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000175515500008).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr18-00222429211000344 .citations}
[Heine Steven J., Proulx Travis, Vohs Kathleen D. (2006), "The Meaning Maintenance Model: On the Coherence of Social Motivations," *Personality and Social Psychology Review*, 10 (2), 88--110. [Crossref](https://doi.org/10.1207/s15327957pspr1002_1). [PubMed](https://pubmed.ncbi.nlm.nih.gov/16768649/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000237232500001).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr19-00222429211000344 .citations}
[Herlocker Jonathan L., Konstan Joseph A., Terveen Loren G., Riedl John T. (2004), "Evaluating Collaborative Filtering Recommender Systems," *ACM Transactions on Information Systems (TOIS)*, 22 (1), 5--53. [Crossref](https://doi.org/10.1145/963770.963772). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000188554900002).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr20-00222429211000344 .citations}
[Iyengar Sheena S., Lepper Mark R. (1999), "Rethinking the Value of Choice: A Cultural Perspective on Intrinsic Motivation," *Journal of Personality and Social Psychology*, 76 (3), 349--66. [Crossref](https://doi.org/10.1037/0022-3514.76.3.349). [PubMed](https://pubmed.ncbi.nlm.nih.gov/10101874/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000079146900001).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr21-00222429211000344 .citations}
[Kim Min Gyung, Mattila Anna S. (2010), "The Impact of Mood States and Surprise Cues on Satisfaction," *International Journal of Hospitality Management*, 29 (3), 432--36. [Crossref](https://doi.org/10.1016/j.ijhm.2009.10.022). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000278694700012).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr22-00222429211000344 .citations}
[King Laura A., Hicks Joshua A., Krull Jennifer L., Gaiso Amber K. Del (2006), "Positive Affect and the Experience of Meaning in Life," *Journal of Personality and Social Psychology*, 90 (1), 179--96. [Crossref](https://doi.org/10.1037/0022-3514.90.1.179). [PubMed](https://pubmed.ncbi.nlm.nih.gov/16448317/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000235112100011).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr23-00222429211000344 .citations}
[Kotkov Denis, Wang Shuaiqiang, Veijalainen Jari (2016), "A Survey of Serendipity in Recommender Systems," *Knowledge-Based Systems*, 111, 180--92. [Crossref](https://doi.org/10.1016/j.knosys.2016.08.014). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000385331700015).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr24-00222429211000344 .citations}
[Krantz David L. (1998), "Taming Chance: Social Science and Everyday Narratives," *Psychological Inquiry* 9 (2), 87--94. [Crossref](https://doi.org/10.1207/s15327965pli0902_1). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000074455300001).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr25-00222429211000344 .citations}
[Kray Laura J., George Linda G., Liljenquist Katie A., Galinsky Adam D., Tetlock Philip E., Roese Neal J. (2010), "From What Might Have Been to What Must Have Been: Counterfactual Thinking Creates Meaning," *Journal of Personality and Social Psychology*, 98 (1), 106--18. [Crossref](https://doi.org/10.1037/a0017905). [PubMed](https://pubmed.ncbi.nlm.nih.gov/20053036/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000273275800009).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr26-00222429211000344 .citations}
[Lambert Nathaniel M., Stillman Tyler F., Hicks Joshua A., Kamble Shanmukh, Baumeister Roy F., Fincham Frank D. (2013), "To Belong Is to Matter: Sense of Belonging Enhances Meaning in Life," *Personality and Social Psychology Bulletin*, 39 (11), 1418--27. [Crossref](https://doi.org/10.1177/0146167213499186). [PubMed](https://pubmed.ncbi.nlm.nih.gov/23950557/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000325658200003).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr27-00222429211000344 .citations}
[Laran Juliano, Tsiros Michael (2013), "An Investigation of the Effectiveness of Uncertainty in Marketing Promotions Involving Free Gifts," *Journal of Marketing*, 77 (2), 112--23. [Crossref](https://doi.org/10.1509/jm.11.0255). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000315430800007).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr28-00222429211000344 .citations}
[Lee Wei-Po, Liu Chih-Hung, Lu Cheng-Che (2002), "Intelligent Agent-Based Systems for Personalized Recommendations in Internet Commerce," *Expert Systems with Applications*, 22 (4), 275--84. [Crossref](https://doi.org/10.1016/S0957-4174(02)00015-5). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000176217800001).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr29-00222429211000344 .citations}
[Leong Tuck, Vetere Frank, Howard Steve (2008), "Abdicating Choice: The Rewards of Letting Go," *Digital Creativity*, 19 (4), 233--43. [Crossref](https://doi.org/10.1080/14626260802550777). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000261464000002).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr30-00222429211000344 .citations}
[Lindgreen Adam, Vanhamme Joëlle (2003), "To Surprise or Not to Surprise Your Customers: The Use of Surprise as a Marketing Tool," *Journal of Customer Behaviour*, 2 (2), 219--42. [Crossref](https://doi.org/10.1362/147539203322383573).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr31-00222429211000344 .citations}
[Loewenstein George (1994), "The Psychology of Curiosity: A Review and Reinterpretation," *Psychological Bulletin*, 116 (1), 75--98. [Crossref](https://doi.org/10.1037/0033-2909.116.1.75). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3AA1994NW25300007).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr32-00222429211000344 .citations}
[Makri Stephann, Blandford Ann (2012), "Coming Across Information Serendipitously--Part 1: A Process Model," *Journal of Documentation*, 68 (5), 684--705. [Crossref](https://doi.org/10.1108/00220411211256030). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000309295600006).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr33-00222429211000344 .citations}
[Matt Christian, Benlian Alexander, Hess Thomas, Weiß Christian (2014), "Escaping from the Filter Bubble? The Effects of Novelty and Serendipity on Users' Evaluations of Online Recommendations," in *Proceedings of the 35th International Conference on Information Systems (ICIS2014)*, Myers Michael D., Straub Detmar W., eds. Auckland, New Zealand: Association for Information Systems, 1503--20.]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr34-00222429211000344 .citations}
[McCay-Peet Lori, Toms Elaine G. (2010), "The Process of Serendipity in Knowledge Work," in Proceedings of the Third Symposium on Information Interaction in Context, Belkin Nicholas J., ed. New York: Association for Computing Machinery, 377--82. [Crossref](https://doi.org/10.1145/1840784.1840842).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr35-00222429211000344 .citations}
[Meade Adam W., Craig S. Bartholomew (2012), "Identifying Careless Responses in Survey Data," *Psychological Methods*, 17 (3), 437--55. [Crossref](https://doi.org/10.1037/a0028085). [PubMed](https://pubmed.ncbi.nlm.nih.gov/22506584/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000308679400010).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr36-00222429211000344 .citations}
[Mellers Barbara A., Schwartz Alan, Ho Katty, Ritov Ilana (1997), "Decision Affect Theory: Emotional Reactions to the Outcomes of Risky Options," *Psychological Science*, 8 (6), 423--29. [Crossref](https://doi.org/10.1111/j.1467-9280.1997.tb00455.x). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3AA1997YE09200003).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr37-00222429211000344 .citations}
[Melo Ricardo, Carvalhais Miguel (2013), "The Design of Horacle: Inducing Serendipity on the Web," in xCoAx 2013: Proceedings of the First Conference on Computation, Communication, Aesthetics and X, Verdicchio Mario, Carvalhais Miguel, eds. Porto, Portugal: Universidade do Porto, 183--91.]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr38-00222429211000344 .citations}
[Morewedge Carey K., Giblin Colleen E., Norton Michael I. (2014), "The (Perceived) Meaning of Spontaneous Thoughts," *Journal of Experimental Psychology. General*, 143 (4), 1742--54. [Crossref](https://doi.org/10.1037/a0036775). [PubMed](https://pubmed.ncbi.nlm.nih.gov/24820251/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000340296200024).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr39-00222429211000344 .citations}
[Parker Mina (2008), *Silver Linings: Meditations on Finding Joy and Beauty in Unexpected Places*. Newburyport, MA: Conari Press.]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr40-00222429211000344 .citations}
[Raghunathan Rajagopal, Irwin Julie R. (2001), "Walking the Hedonic Product Treadmill: Default Contrast and Mood-Based Assimilation in Judgments of Predicted Happiness with a Target Product," *Journal of Consumer Research*, 28 (3), 355--68. [Crossref](https://doi.org/10.1086/323727). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000172762300002).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr41-00222429211000344 .citations}
[Reisenzein Rainer, Horstmann Gernot, Schützwohl Achim (2019), "The Cognitive-Evolutionary Model of Surprise: A Review of the Evidence," *Topics in Cognitive Science*, 11 (1), 50--74. [Crossref](https://doi.org/10.1111/tops.12292). [PubMed](https://pubmed.ncbi.nlm.nih.gov/28940761/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000459580800004).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr42-00222429211000344 .citations}
[Shanahan Michael J., Porfeli Erik J. (2006), "Chance Events in the Life Course," *Advances in Life Course Research*, 11, 97--119. [Crossref](https://doi.org/10.1016/S1040-2608(06)11004-7).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr43-00222429211000344 .citations}
[Sharot Tali, De Benedetto, Martino, Dolan Raymond J. (2009), "How Choice Reveals and Shapes Expected Hedonic Outcome," *Journal of Neuroscience*, 29 (12), 3760--65. [Crossref](https://doi.org/10.1523/JNEUROSCI.4972-08.2009). [PubMed](https://pubmed.ncbi.nlm.nih.gov/19321772/). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000264544900010).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr44-00222429211000344 .citations}
[Stiensmeier-Pelster Joachim, Martini Alice, Reisenzein Rainer (1995), "The Role of Surprise in the Attribution Process," *Cognition and Emotion*, 9 (1), 5--31. [Crossref](https://doi.org/10.1080/02699939508408963). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=A1995QG85700003).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr45-00222429211000344 .citations}
[Valenzuela Ana, Mellers Barbara, Strebel Judi (2010), "Pleasurable Surprises: A Cross-Cultural Study of Consumer Responses to Unexpected Incentives," *Journal of Consumer Research*, 36 (5), 792--805. [Crossref](https://doi.org/10.1086/605592). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000273302200007).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr46-00222429211000344 .citations}
[VanBergen Noah, Laran Juliano (2016), "Loss of Control and Self-Regulation: The Role of Childhood Lessons," *Journal of Consumer Research*, 43 (4), 534--48. [Crossref](https://doi.org/10.1093/jcr/ucw042). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3A000397943100003).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr47-00222429211000344 .citations}
[Walpole Horace (1754), "Letter to Horace Mann, 28 January 1754," in *Horace Walpole's Correspondence: Yale Edition \[Electronic Version\]*, Vol. 20, Lewis Wilmarth S., ed. Farmington, CT: The Lewis Walpole Library, Yale University, 407--408. <https://images.library.yale.edu/hwcorrespondence/page.asp?vol=20&seq=435>.]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr48-00222429211000344 .citations}
[Westbrook Robert A., Oliver Richard L. (1991), "The Dimensionality of Consumption Emotion Patterns and Consumer Satisfaction," *Journal of Consumer Research*, 18 (1), 84--91. [Crossref](https://doi.org/10.1086/209243). [Web of Science](https://gateway.webofknowledge.com/gateway/Gateway.cgi?GWVersion=2&DestApp=WOS_CPL&UsrCustomerID=5e3815c904498985e796fc91436abd9a&SrcAuth=atyponcel&SrcApp=literatum&DestLinkType=FullRecord&KeyUT=WOS%3AA1991FY50600009).]{.citation}
:::
::::

:::: {role="listitem"}
::: {#index.xhtml_bibr49-00222429211000344 .citations}
[Zhang Yuan Cao, Séaghdha Diarmuid Ó., Quercia Daniele, Jambor Tamas (2012), "Auralist: Introducing Serendipity into Music Recommendation," in Proceedings of the Fifth ACM International Conference on Web Search and Data Mining, Adar Eytan, Teevan Jaime, eds. New York: Association for Computing Machinery, 13--22. [Crossref](https://doi.org/10.1145/2124295.2124300).]{.citation}
:::
::::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
